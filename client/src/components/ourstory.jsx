...
const OurStory = () => {
  ...
  useEffect(() => {
    ...
    // Wait for the embed to load before attempting autoplay
    const checkEmbed = setInterval(() => {
      if (document.querySelector('iframe.instagram-media-rendered')) {
        clearInterval(checkEmbed);
        attemptAutoplay();
      }
    }, 1000);

    return () => clearInterval(checkEmbed);
  }, []);
          ...
          >
            <div className="video-container">
              <blockquote 
                ...
                data-instgrm-permalink="https://www.instagram.com/reel/C-1GlXYiYje/?utm_source=ig_embed&amp;utm_campaign=loading" 
              ...
              >
                <div style={{ padding: '16px' }}>
                  <a 
                    href="https://www.instagram.com/reel/C-1GlXYiYje/?utm_source=ig_embed&amp;utm_campaign=loading" 
                    style={{ 
                      background: '#FFFFFF',
                      lineHeight: '0',
                      padding: '0 0',
                  ...
                  <p style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', lineHeight: '17px', marginBottom: '0', marginTop: '8px', overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                    <a href="https://www.instagram.com/reel/C-1GlXYiYje/?utm_source=ig_embed&amp;utm_campaign=loading" style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px', textDecoration: 'none' }} target="_blank" rel="noopener noreferrer">A post shared by 𝗗𝗜𝗚𝗜𝗧𝗔𝗟 𝗠𝗢𝗩𝗘 𝗨𝗣 (@dmoveup)</a>
                  </p>
                </div>
              </blockquote>
            </div>
